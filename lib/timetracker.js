...
tt.TimeTracker = new Class({
	...
	initWindow: function() {
		...
		this.states.templates.resized(window.nativeWindow.width, window.nativeWindow.height);
		this.states.tracker.resized(window.nativeWindow.width, window.nativeWindow.height);
