tt.Goal = new Class({
    ...
    computeGoal: function() {
        var remaining = Math.max(0, this.timeAmount * 60000 - this.tracker.getTotal());
        ...
        this.goalDoneTime.innerHTML = new Date(new Date().getTime() + remaining).toLocaleTimeString();
    }
});